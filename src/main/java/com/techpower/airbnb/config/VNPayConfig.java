...
public class VNPayConfig {
    ...
    public static final String TMN_CODE = "CQS0C15E";
    ...
    public static final String RETURN_URL = "http://localhost:8080/api/v1/payment/vnpay/transaction/panther";
    public static final String HASH_SECRET = "KQYEZMXVYYUBLIVFJTKXKKMVQTIMJPLG";
    public static final String API_URL = "https://sandbox.vnpayment.vn/merchant_webapi/api/transaction/panther";
